...
const NODES: StatusNode[] = [
  ...
  },
  {
    ...
    nameJa: '技術・人文知識・国際業務',
    descEn: 'A work status used by graduates of universities and vocational schools (専門士) for jobs related to their studies — the ISA lists it among the working statuses of residence. Job duties must relate to your degree or diploma.',
    descJa: '大学・専門学校（専門士）の卒業者が、専攻と関連する職務に就く際に用いられる就労資格の一つです（出入国在留管理庁の在留資格一覧参照）。職務内容が学位・専門士と関連している必要があります。',
  ...
  },
  {
    ...
    nameJa: '高度専門職',
    descEn: 'Points-based status calculated from education, salary, age, Japanese ability, and other factors on the official chart. Meeting the points threshold can shorten some long-term timelines.',
    descJa: '学歴・年収・年齢・日本語能力などを公式のポイント計算表で計算する制度です。基準点に達すると長期在留までの期間が短くなる場合があります。',
  ...
  },
  {
    ...
    requirementsEn: [
      'Continuous residence (generally 10+ years, incl. 5+ on work/residence status)',
      'Holding the longest period of stay for your current status — under the current guideline this is treated as satisfied, for the time being, by holding a 3-year period of stay',
      'Good conduct & independent livelihood',
      'Taxes, pension, and health-insurance obligations performed properly AND on time — the guideline warns that late payment may be evaluated negatively even if everything is paid by the time you apply',
    ],
    requirementsJa: [
      '継続した在留（原則10年以上・うち就労資格等5年以上）',
      '現に有している在留資格について最長の在留期間をもって在留していること（現行ガイドラインでは、当面「3年」の在留期間があれば最長の在留期間として取り扱われます）',
      '素行善良・独立生計',
      '税金・年金・健康保険の適正な納付（納付期限を守ること。申請時までに納付済みでも、納付遅れは審査上マイナスに評価され得るとガイドラインに明記されています）',
    ],
    sources: [
