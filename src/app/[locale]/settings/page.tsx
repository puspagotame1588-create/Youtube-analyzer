...
/** Settings — quality tier, language, data export, account deletion. */
          ...
          {prefs.map((p) => (
            <button
              ...
              className={`rounded-xl border-2 p-3 text-left text-sm transition-colors ${
                preference === p.id ? 'border-cyan2 bg-cyan2/5' : 'border-transparent bg-white/60 hover:border-cyan2/30'
              }`}
            >
